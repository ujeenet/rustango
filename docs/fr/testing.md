...
|---|---:|---|
| *(aucune)* | 216 | Rien — une SQLite en mémoire ou en fichier temporaire. Tournent toujours. |
| `DATABASE_URL` | 89 | Un serveur PostgreSQL joignable. |
| `MYSQL_TEST_URL` | 18 | Un serveur MySQL 8+ joignable. **Pas** `DATABASE_URL`. |
