//! Tenant-facing login + session — analog of [`crate::operator_console`]
//! but scoped to a single tenant's user pool.
//!
//! The tenant admin (built via [`crate::admin::TenantAdminBuilder`])
...
pub use crate::operator_console::SessionSecret;
use crate::operator_console::session::{sign, SessionError};
